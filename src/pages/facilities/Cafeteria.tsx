...
import canteen2 from "@/assets/canteen-2.jpg";
        ...
        <div className="container mx-auto px-4 flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="lg:w-1/2">
            ...
            <p className="text-muted-foreground mb-6 leading-relaxed text-lg">
              A hygienic canteen provides fresh food items. Junk foods are
              discouraged at school. The rates are always in accordance with the
              agreement with the school. However, students are encouraged to
              carry their Tiffin’s.
            </p>
          </div>

          {/* Image Carousel */}
          <div className="lg:w-1/2">
            <ImageCarousel images={[canteen1, canteen2]} altText="Canteen" />
          </div>
        </div>
      </section>
    </div>
